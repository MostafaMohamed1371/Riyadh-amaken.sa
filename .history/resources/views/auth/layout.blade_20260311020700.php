...
<body class="min-h-screen bg-slate-100 text-slate-800 antialiased">
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden lg:flex lg:min-h-screen lg:flex-1 lg:flex-col lg:justify-between bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 px-12 py-16 xl:px-16 xl:py-20">
            {{-- Top: R + Riyadh Amaken --}}
