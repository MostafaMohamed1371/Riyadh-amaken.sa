...
<body class="min-h-screen bg-slate-100 text-slate-800 antialiased">
    <div class="flex min-h-screen">
        ...
        <div class="relative hidden lg:flex lg:min-h-screen lg:flex-1 bg-gradient-to-br from-emerald-600 via-emerald-700 to-teal-800 px-12 py-16 xl:px-16 xl:py-20">
            {{-- Top: R + Riyadh Amaken --}}
            <div class="absolute left-12 top-16 xl:left-16 xl:top-20">
            ...
            {{-- Bottom: tagline + copyright (fixed at bottom of panel) --}}
            <div class="absolute bottom-16 left-12 right-12 flex flex-col gap-4 xl:bottom-20 xl:left-16 xl:right-16">
