...
Route::get('sliders', [LegacySliderController::class, 'index']);
Route::get('sliders/{slider}', [LegacySliderController::class, 'show']);
Route::get('gallery', [LegacyGalleryController::class, 'index']);
Route::get('gallery/{gallery}', [LegacyGalleryController::class, 'show']);
Route::get('activities', [LegacyActivityController::class, 'index']);
Route::get('activities/{activity}', [LegacyActivityController::class, 'show']);
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::apiResource('sliders', LegacySliderController::class)->except(['index', 'show']);
    ...
    Route::apiResource('gallery', LegacyGalleryController::class)->except(['index', 'show']);
    Route::apiResource('activities', LegacyActivityController::class)->except(['index', 'show']);
