...
<div class="space-y-6">
    ...
    <x-admin.card>
        <x-slot:header>
            <h2 class="text-lg font-semibold text-slate-800">New Slider</h2>
        </x-slot:header>
        <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4"
                        class="mt-1.5 block w-full rounded-xl border-slate-300 bg-white px-4 py-2.5 text-slate-800 shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">{{ old('description') }}</textarea>
                </div>
                <div>
            ...
            <div class="flex gap-3">
                <x-admin.btn type="submit" variant="primary">Create Slider</x-admin.btn>
