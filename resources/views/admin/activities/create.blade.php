...
<div class="space-y-6">
    ...
    <x-admin.card>
        <x-slot:header><h2 class="text-lg font-semibold text-slate-800">New Activity</h2></x-slot:header>
        <form action="{{ route('admin.activities.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="tags" id="tags" value="{{ old('tags') }}" placeholder="tag1, tag2" class="mt-1.5 block w-full rounded-xl border-slate-300 bg-white px-4 py-2.5 shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="working_hours" id="working_hours" value="{{ old('working_hours') }}" placeholder="9AM - 5PM" class="mt-1.5 block w-full rounded-xl border-slate-300 bg-white px-4 py-2.5 shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">
                </div>
                <div>
                    <label for="phone" class="block text-sm font-medium text-slate-700">Phone</label>
                    <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="mt-1.5 block w-full rounded-xl border-slate-300 bg-white px-4 py-2.5 shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">
                </div>
                <div>
                    <label for="rate" class="block text-sm font-medium text-slate-700">Rate</label>
                    <input type="number" name="rate" id="rate" value="{{ old('rate') }}" step="0.01" min="0" class="mt-1.5 block w-full rounded-xl border-slate-300 bg-white px-4 py-2.5 shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20">
                </div>
                <div class="sm:col-span-2">
